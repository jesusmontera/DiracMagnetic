...
class Ui_DlgDiract(object):
    def setupUi(self, DlgDiract):
        ...
        self.groupBoxSpin.setGeometry(QtCore.QRect(0, 140, 581, 291))
        ...
        self.btPlotSpin.setGeometry(QtCore.QRect(120, 240, 181, 41))
        ...
        self.bttop = QtWidgets.QPushButton(self.groupBoxSpin)
        self.bttop.setGeometry(QtCore.QRect(0, 200, 51, 25))
        self.bttop.setObjectName("bttop")
        self.btbottom = QtWidgets.QPushButton(self.groupBoxSpin)
        self.btbottom.setGeometry(QtCore.QRect(60, 200, 71, 25))
        self.btbottom.setObjectName("btbottom")
        self.btleft = QtWidgets.QPushButton(self.groupBoxSpin)
        self.btleft.setGeometry(QtCore.QRect(140, 200, 51, 25))
        self.btleft.setObjectName("btleft")
        self.btright = QtWidgets.QPushButton(self.groupBoxSpin)
        self.btright.setGeometry(QtCore.QRect(200, 200, 51, 25))
        self.btright.setObjectName("btright")
        self.btfront = QtWidgets.QPushButton(self.groupBoxSpin)
        self.btfront.setGeometry(QtCore.QRect(260, 200, 51, 25))
        self.btfront.setObjectName("btfront")
        self.btback = QtWidgets.QPushButton(self.groupBoxSpin)
        self.btback.setGeometry(QtCore.QRect(320, 200, 51, 25))
        self.btback.setObjectName("btback")
        self.groupBoxMode = QtWidgets.QGroupBox(DlgDiract)
        self.groupBoxMode.setGeometry(QtCore.QRect(400, 20, 171, 131))
        font = QtGui.QFont()
        font.setFamily("Sans")
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.groupBoxMode.setFont(font)
        self.groupBoxMode.setStyleSheet("background-color: rgb(64, 98, 191);\n"
"color: rgb(238, 238, 236);")
        self.groupBoxMode.setObjectName("groupBoxMode")
        self.opcSplit = QtWidgets.QRadioButton(self.groupBoxMode)
        self.opcSplit.setGeometry(QtCore.QRect(30, 40, 112, 23))
        font = QtGui.QFont()
        font.setPointSize(15)
        self.opcSplit.setFont(font)
        self.opcSplit.setObjectName("opcSplit")
        self.opcEigen = QtWidgets.QRadioButton(self.groupBoxMode)
        ...
        self.groupBoxB = QtWidgets.QGroupBox(DlgDiract)
        self.groupBoxB.setGeometry(QtCore.QRect(390, 30, 181, 131))
        font = QtGui.QFont()
        font.setFamily("Sans")
        font.setPointSize(13)
        font.setBold(True)
        font.setWeight(75)
        self.groupBoxB.setFont(font)
        self.groupBoxB.setStyleSheet("background-color: rgb(14, 60,11);\n"
"color: rgb(238, 238, 236);")
        self.groupBoxB.setObjectName("groupBoxB")
        self.opcBpot = QtWidgets.QRadioButton(self.groupBoxB)
        self.opcBpot.setGeometry(QtCore.QRect(10, 40, 151, 23))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.opcBpot.setFont(font)
        self.opcBpot.setChecked(True)
        self.opcBpot.setObjectName("opcBpot")
        self.opcBdot = QtWidgets.QRadioButton(self.groupBoxB)
        self.opcBdot.setGeometry(QtCore.QRect(10, 80, 151, 23))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.opcBdot.setFont(font)
        self.opcBdot.setChecked(False)
        self.opcBdot.setObjectName("opcBdot")
    ...
    def retranslateUi(self, DlgDiract):
        ...
        self.txposX.setText(_translate("DlgDiract", "0.0"))
        self.txposY.setToolTip(_translate("DlgDiract", "<html><head/><body><p>from -0.8 to 0.8</p></body></html>"))
        self.txposY.setText(_translate("DlgDiract", "-0.7"))
        ...
        self.txkX.setText(_translate("DlgDiract", "0"))
        self.txkY.setText(_translate("DlgDiract", "20"))
        ...
        self.opcspin0.setText(_translate("DlgDiract", "spinors from k (with spin up in Z)"))
        ...
        self.txspinupreal.setText(_translate("DlgDiract", "1"))
        ...
        self.bttop.setText(_translate("DlgDiract", "top"))
        self.btbottom.setText(_translate("DlgDiract", "bottom"))
        self.btleft.setText(_translate("DlgDiract", "left"))
        self.btright.setText(_translate("DlgDiract", "right"))
        self.btfront.setText(_translate("DlgDiract", "front"))
        self.btback.setText(_translate("DlgDiract", "back"))
        self.groupBoxMode.setTitle(_translate("DlgDiract", "Simulation Mode "))
        ...
        self.groupBoxB.setTitle(_translate("DlgDiract", "B magnetic mode"))
        self.opcBpot.setText(_translate("DlgDiract", "B as potential"))
        self.opcBdot.setText(_translate("DlgDiract", "B as dot vector"))
